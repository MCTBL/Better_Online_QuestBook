            ...
            "data": [
                {
                    ...
                    "x": 216.0,
                    "y": -72.0,
                    "tooltip": "This is the advanced assembly line from \u00a76GigaGram<br/>\u00a7rFab.\n\nIt supports item pipelining. That is, it w<br/>ill mimic a real assembly line by consuming ingred<br/>ients one by one instead of all at start. In effec<br/>t, it offers a parallelism up to however many item<br/> input this recipe requires. You can think of an a<br/>dvanced assembly line as a collection of slices wh<br/>ich are capable of processing each step independen<br/>tly from other slices. It will start processing on<br/>ce the input bus contents align with any stored da<br/>ta stick. The first slice will consume the input i<br/>n Bus #1. After (recipe time/number of inputs) tim<br/>e, the first slice's work is concluded and will st<br/>art the second slice. At the same time, first slic<br/>e will look for input in input bus #1. If there ar<br/>e still enough input there slice #1 will start wor<br/>king again.\n\nThe terminal slice (the n-th slice, w<br/>here n is number of item input in recipe) will put<br/> the recipe output in output bus when it has concl<br/>uded his work. Whenever a non-terminal slice finis<br/>hed its work, it will try to pass the work onto ne<br/>xt slice. If the next slice cannot find the materi<br/>als in its input bus, the just-finished slice will<br/> remain in [warn]STUCK[/warn] state and hang the a<br/>ssembly line. To help locate these [warn]STUCK[/wa<br/>rn] assembly lines, the controller's front face wi<br/>ll have its status light turned orange.\n\nThe EU/t <br/>cost of this machine is number of slices active mu<br/>ltiplied by the original recipe EU/t. [warn]STUCK[<br/>/warn] slices do not consume power. It will use th<br/>e worst energy supplying hatch's input voltage for<br/> recipe tier calculation and normal imperfect over<br/>clock. With exotic energy hatches, it can overcloc<br/>k beyond usual voltage tier, but will consume even<br/> more power than usual imperfect overclock. Every <br/>\u00a72laser overclock\u00a7r will 0.3 to power exponent. 1 <br/>\u00a72laser overclock\u00a7r will have 50% recipe time and <br/>use 430% power. 2 \u00a72laser overclocks\u00a7r will have 2<br/>5% recipe time and use 1978% power. Will not overc<br/>lock beyond 1 tick. Machine first tries to paralle<br/>lize, then normal imperfect overclock, then \u00a72lase<br/>r overclock\u00a7r."
                },
                {
                    ...
                    "x": 144.0,
                    "y": -144.0,
                    "tooltip": "In LuV, you can make the Industrial Autoclave. Thi<br/>s is a huge multiblock with many scaling factors -<br/> it is also extremely powerful. You'll definitely <br/>want to pick one of these up to process crystal ch<br/>ips quickly for the crystal circuit line.\n\n[note]C<br/>oils, pipe casings, and item pipe casings are all <br/>extremely important to this multi's scaling. Use t<br/>he best ones you have![/note]"
                },
                {
                ...
                },
                {
                    ...
                    "x": -24.0,
                    "y": -120.0,
                    "tooltip": "How does one centrifuge rare materials in the Stea<br/>m Age? The answer is by building and using the Ste<br/>am Separator, of course! By using steam to create <br/>a spinning force, this Multiblock can separate dif<br/>ferent materials quickly and easily.\n\nIf you think<br/> separation is taking forever, the Steam Separator<br/> will speed things up!\n\n\u00a73\u00a73This Multiblock can pr<br/>ocess recipes up to LV Tier, and does accept an Ou<br/>tput Hatch for recipes. But if you are looking to <br/>use recipes which require Fluid Inputs, you might <br/>have to build an LV Centrifuge in the future."
                },
                {
                    "name": "\u57fa\u5730\u706b\u5c71",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 144.0,
                    "y": 60.0,
                    "tooltip": "\u751f\u4ea7\u5706\u77f3\u7684\u7ec8\u6781\u673a\u5668.\u4e5f\u53ef\u4ee5\u5c06\u7ea2\u77f3\u5927\u89c4\u6a21\u8f6c\u5316\u4e3a\u9ed1\u66dc\u77f3,\u4ee5\u83b7\u53d6\u53ef\u518d\u751f\u7684\u7845\u3001\u9541\u3001\u94c1\u548c\u6c27."
                },
                {
                    "name": "\u6c90\u6d74\u5728\u7535\u6d41\u4e2d",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 168.0,
                    "y": -72.0,
                    "tooltip": "\u6210\u767e\u4e0a\u5343\u73bb\u7483\u7684\u6700\u4f73\u6765\u6e90...\u8981\u8fd9\u4e9b\u505a\u4ec0\u4e48\u5462?\u6211\u4e0d\u77e5\u9053,\u8fd8\u662f\u60f3\u70b9\u6709\u8da3\u7684\u7528\u9014,\u7ed9\u6211\u5f00\u5f00\u773c\u5427!\u5de5\u4e1a\u7535\u5f27\u7089\u7684<br/>\"\u6709\u6548\"\u7535\u538b\u6bd4\u80fd\u6e90\u4ed3\u8981\u4f4e\u4e00\u9636.\u4e3e\u4e2a\u4f8b\u5b50,\u4f7f\u7528MV\u80fd\u6e90\u4ed3,\u673a\u5668\u53ef\u5904\u7406LV\u7535\u5f27\u7089\u7684\u914d\u65b9.\u8fd9\u53f0\u673a\u5668\u8fd8\u53ef\u4ee5\u5904<br/>\u7406\u7b49\u79bb\u5b50\u7535\u5f27\u7089\u7684\u914d\u65b9.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728LuV\u9636\u6bb5\u5236\u9020. \u539f\u6599\u4e4b\u4e00\u662f\u948d-232,\u4e00\u65b9\u9762\u7528\u9014\u4e0d\u591a,\u53e6<br/>\u4e00\u65b9\u9762\u5236\u9020\u8d77\u6765\u8fd8\u7279\u522b\u9ebb\u70e6.\u8bd1\u8005\u6ce8: \u948d-232\u7b97\u5565,\u770b\u770b\u5957\u5a03\u80fd\u91cf\u6838\u5fc3! \u4e0d\u8fc7\u505a\u51fa\u6765\u4e4b\u540e\u8fd8\u662f\u5f88\u9999\u7684."
                },
                {
                    "name": "\u6405\u62cc/\u6405\u62cc/\u5de7\u514b\u529b",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 156.0,
                    "y": 276.0,
                    "tooltip": "\u5976\u5976,\u4f60\u80fd\u6559\u6211\u4eec\u5de7\u514b\u529b\u4e4b\u6b4c\u5417?\u4e50\u610f\u4e4b\u81f3!\u4f60\u4f1a\u8ddf\u6211\u4eec\u4e00\u8d77\u5531\u5de7\u514b\u529b\u4e4b\u6b4c\u5417?\u592a\u68d2\u4e86,\u8ddf\u7740\u5976\u5976\u4e00\u8d77\u5531!\u6405\u62cc,<br/>\u6405\u62cc,\u5de7\u514b\u529b\u6405\u62cc,\u6405\u62cc,\u5de7\u514b\u529b\u6405\u62cc,\u6405\u62cc,\u5de7\u514b\u529b\u6405\u62cc,\u6405\u62cc,\u5de7\u514b\u529b\u6405\u62cc\u597d\u5403\u7684\u5de7\u514b\u529b,\u5de7\u514b\u529b\u6405\u62cc\u597d\u5403\u7684<br/>\u5de7\u514b\u529b,\u5de7\u514b\u529b\u6405\u62cc,\u6405\u62cc,\u5de7\u514b\u529b\u6405\u62cc,\u6405\u62cc,\u5de7\u514b\u529b\u73b0\u5728\u4e0d\u518d\u9700\u8981\u5355\u5143\u4e86,\u597d\u8036!\u8bd1\u8005\u6ce8:\u300a\u6405\u62cc,\u6405\u62cc,\u5de7<br/>\u514b\u529b\u300b(Bate-Bate-Chocolate)\u662f\u58a8\u897f\u54e5\u4f20\u7edf\u513f\u6b4c.\u4efb\u52a1\u4e66\u539f\u6587\u6b4c\u8bcd\u90e8\u5206\u5747\u4e3a\u897f\u73ed\u7259\u6587."
                },
                {
                    "name": "\u5f2f\u66f2\u3001\u8f8a\u538b",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -36.0,
                    "y": 216.0,
                    "tooltip": "\u5f53\u4f60\u9700\u8981\u6210\u5343\u4e0a\u4e07\u7684\u677f\u5b50\u65f6... \u53ef\u901a\u8fc7\u87ba\u4e1d\u5200\u5207\u6362\u5377\u677f\u673a\u6a21\u5f0f\u548c\u51b2\u538b\u673a\u5e8a\u6a21\u5f0f.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636<br/>\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u6700\u597d\u7684\u5207\u9762\u5305\u673a",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 144.0,
                    "y": 84.0,
                    "tooltip": "\u5f53\u4f60\u6709\u4e86\u4e00\u53f0\u88c5\u6ee1\u4e86\u5c0f\u5200\u7684\u673a\u5668,\u4f60\u770b\u5565\u90fd\u50cf\u9762\u5305\u4e86. \u4f7f\u7528\u87ba\u4e1d\u5200\u53ef\u5207\u6362\u677f\u6750\u5207\u5272\u673a\u6a21\u5f0f\u548c\u98df\u6750\u5207\u7247\u673a\u6a21\u5f0f.B<br/>luebine-2019!\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u8d4c\u4e0a\u84b8\u998f",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 240.0,
                    "y": 12.0,
                    "tooltip": "IV\u9636\u6bb5\u5e26\u6765\u4e86\u56db\u79cdGT++\u591a\u65b9\u5757\u673a\u5668,\u5305\u62ec\u84b8\u998f\u5854\u7684\u5347\u7ea7\u7248\u672c,\u79f0\u4e4b\u4e3a\u4e39\u683c\u7279\u84b8\u998f\u5382. \u5b83\u4e0e\u84b8\u998f\u5854\u5728\u7ed3\u6784\u4e0a<br/>\u5b8c\u5168\u76f8\u540c,\u53ea\u662f\u4f7f\u7528\u7684\u63a7\u5236\u5668\u65b9\u5757\u4e0d\u540c. \u8fd9\u4e2a\u63a7\u5236\u5668\u65b9\u5757\u7684\u5408\u6210\u66f4\u52a0\u590d\u6742,\u9700\u8981\u66f4\u6602\u8d35\u7684\u6750\u6599,\u5e76\u4e14\u4e5f\u9501\u5b9a\u53ea\u80fd<br/>\u7528IV\u4ee5\u4e0a\u7684\u5316\u5de5\u5382\u5408\u6210,\u8fd9\u4e5f\u4f7f\u5f97\u5982\u679c\u4ec5\u4e3a\u6b64\u5408\u6210\u5347\u7ea7\u5316\u5de5\u5382\u7684\u8bdd,\u90a3\u8fd9\u4e2a\u5408\u6210\u914d\u65b9\u5c31\u663e\u5f97\u66f4\u8d35\u4e86.\u4e0d\u8fc7\u8bdd\u8bf4\u56de<br/>\u6765,\u4e39\u683c\u7279\u89e3\u51b3\u4e86\u84b8\u998f\u5854\u8fd0\u884c\u7f13\u6162\u7684\u95ee\u9898,\u800c\u4e14\u4ece\u672c\u8d28\u4e0a\u6765\u8bf4,\u84b8\u998f\u5854\u662f\u6240\u6709\u8fd9\u4e9b\u53ef\u518d\u751f\u8d44\u6e90\u751f\u4ea7\u7ebf\u7684\u652f\u67f1. \u60f3<br/>\u8981\u9760\u53ef\u518d\u751f\u80fd\u6e90\u83b7\u5f97\u53ef\u9760\u7684IV/LuV\u7535\u529b,\u4f60\u8fd8\u9700\u8981\u591a\u5c11\u56db\u8054\u84b8\u998f\u5854\u5462?\u53bb\u5427."
                },
                {
                    "name": "\u8d1d\u7d22\u65af\u7684\u9a84\u50b2",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 216.0,
                    "y": 0.0,
                    "tooltip": "\u4e9a\u9a6c\u900a\u4ed3\u5e93\u662f\u6ee1\u8db3\u4f60\u6240\u6709\u6253\u5305\u9700\u6c42\u7684\u7ec8\u6781\u9009\u62e9.\u5c0f\u64ae\u7c89\u548c\u5c0f\u5806\u7c89\u5b9e\u5728\u592a\u591a?\u8fd9\u53f0\u673a\u5668\u4e3a\u4f60\u800c\u751f.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef<br/>\u4ee5\u5728LuV\u9636\u6bb5\u5236\u9020.\u8bd1\u8005\u6ce8:\u6770\u592b\u00b7\u8d1d\u7d22\u65af(Jeff Bezos)\u662f\u4e9a\u9a6c\u900a\u516c\u53f8\u7684CEO."
                },
                {
                    "name": "\u7ed9\u6211\u4e00\u5927\u6876\u805a\u4e59\u70ef!",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": -24.0,
                    "y": 72.0,
                    "tooltip": "If you've ever needed to wait on a Canning Machine<br/> to fill up your supply of tin cans, or for a Flui<br/>d Canning Machine to make mountains of coolant, co<br/>nsider the TurboCan Pro. This multiblock acts as b<br/>oth machines and has significant bonuses - when th<br/>e time comes that you decide you need it!"
                },
                {
                    "name": "\u7535\u8def\u88c5\u914d\u7ebf",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": 252.0,
                    "y": 252.0,
                    "tooltip": "\u4ed6\u4eec\u7528\u81ea\u52a8\u5316\u6765\u5b8c\u6210.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020,\u4e0d\u8fc7\u8fd8\u8981\u7528\u5230\u94c2\u7ebf\u548cZPM\u7535\u8def\u677f."
                },
                {
                    ...
                    "x": -96.0,
                    "y": 48.0,
                    "tooltip": "How much oil do you need? Or maybe it's Naquadah F<br/>uel you're after, or Radox... either way, this mas<br/>sive structure can handle it, boasting 256 paralle<br/>ls."
                },
                {
                    "name": "\u65cb\u8f6c,\u8df3\u8dc3",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -12.0,
                    "y": 276.0,
                    "tooltip": "\u65cb\u8f6c,\u5347\u6e29--\u542c\u8d77\u6765\u50cf\u4e00\u4e2a\u821e\u8e48. \u6216\u662f\u70ed\u529b\u79bb\u5fc3\u673a. \u5efa\u9020\u4e00\u4e2a\u5de5\u4e1a\u70ed\u529b\u7cbe\u70bc\u5382,\u4ee5\u5145\u5206\u5229\u7528\u4f60\u7684\u77ff\u77f3.\u53ea\u8981<br/>\u4fdd\u8bc1\u81f3\u5c118\u4e2a\u70ed\u5904\u7406\u673a\u68b0\u65b9\u5757,\u4f60\u5c31\u53ef\u4ee5\u7528\u566a\u97f3\u5371\u9669\u6807\u5fd7\u6765\u4ee3\u66ff\u70ed\u5904\u7406\u673a\u68b0\u65b9\u5757.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5<br/>\u5236\u9020.\u6ce8\u610f\u6d88\u58f0\u4ed3\u5b89\u88c5\u5728\u5e95\u5c42."
                },
                {
                    "name": "\u628a\u6d77\u6d0b\u635e\u7a7a",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 240.0,
                    "y": 84.0,
                    "tooltip": "\u4e3a\u4e86\u751f\u7269\u67f4\u6cb9,\u5f88\u957f\u4e00\u6bb5\u65f6\u95f4\u91cc,\u4f60\u90fd\u7528\u9c7c\u7b3c\u6355\u9c7c.\u73b0\u5728,\u4f60\u53ef\u4ee5\u5efa\u9020\u73e0\u6d77\u6e14\u573a,\u6536\u83b7\u6210\u5428\u7684\u9c7c\u548c\u526f\u4ea7\u7269.\u8fd9\u53f0\u591a<br/>\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    ...
                    "x": 144.0,
                    "y": 12.0,
                    "tooltip": "Sick of having to swap out lenses or make tens of <br/>laser engravers for your cleanroom? The Hyper-Inte<br/>nsity Laser Engraver is here for you. This multibl<br/>ock can handle all of your engraving needs.\n\nBy us<br/>ing more powerful \u00a7lLaser Source Hatches\u00a7l \u00a7rin th<br/>e structure, you can gain more parallels and run h<br/>igher tier recipes. "
                },
                {
                    ...
                    "x": 60.0,
                    "y": 276.0,
                    "tooltip": "Nothing turns solids to liquids faster than the La<br/>rge Fluid Extractor - not yet, anyways. You'll nee<br/>d to make both Heating and Solenoid Coils for this<br/> multiblock.\n\n[note]This multiblock is technically<br/> EV, but it will demand a lot of tungstensteel.[/n<br/>ote]"
                },
                {
                ...
                },
                {
                    ...
                    "x": 168.0,
                    "y": 0.0,
                    "tooltip": "Making machines for every mold sounds tiring... fo<br/>rtunately, the Fluid Shaper multiblock can handle <br/>any number of molds by using \u00a7lSolidifier Hatches\u00a7<br/>r. This multiblock is also extendable, gaining mor<br/>e parallels if you add additional segments. Be sur<br/>e to expand it if it's too slow!\n\n[note]The Fluid <br/>Shaper also speeds up as it is running, making it <br/>more efficient to do large batches.[/note]"
                },
                {
                    "name": "\u51bb\u4f24!",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -96.0,
                    "y": 12.0,
                    "tooltip": "\u8fd9\u53f0\u5de8\u578b\u771f\u7a7a\u51b7\u51bb\u673a\u53ef\u4ee5\u540c\u65f6\u5904\u7406\u6700\u591a256\u4e2a\u914d\u65b9."
                },
                {
                    "name": "\u51bb\u50f5\u4e86...",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 216.0,
                    "y": 96.0,
                    "tooltip": "\u6211\u597d\u51b7\u554a...\u60f3\u8981\u6b63\u5e38\u4f7f\u7528\u8fd9\u53f0\u673a\u5668,\u4f60\u9700\u8981\u7ed9\u5b83\u6301\u7eed\u4f9b\u5e94\u6781\u5bd2\u4e4b\u51db\u51b0.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728LuV\u9636\u6bb5\u5236\u9020<br/>."
                },
                {
                    "name": "\u4e0a\u5e1d\u7684\u953b\u9020\u53f0",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 168.0,
                    "y": 96.0,
                    "tooltip": "\u70bd\u7131\u9ad8\u7089\u80fd\u4ee5\u96be\u4ee5\u7f6e\u4fe1\u7684\u901f\u5ea6\u5904\u7406\u7269\u54c1. \u60f3\u8981\u6b63\u5e38\u4f7f\u7528\u8fd9\u53f0\u673a\u5668,\u4f60\u9700\u8981\u7ed9\u5b83\u6301\u7eed\u4f9b\u5e94\u70c8\u7130\u4e4b\u70bd\u7131,\u8fd8\u5f97\u914d\u4e0a\u597d<br/>\u7684\u7ebf\u5708.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020,\u4f46\u9700\u8981\u4e24\u4e2aZPM\u7535\u8def\u677f.\u8bd1\u8005\u6ce8:\u70bd\u7131\u9ad8\u7089\u6ca1\u6709\u7535\u538b\u7b49\u7ea7\u5e26\u6765\u7684<br/>\u989d\u5916\u7089\u6e29\u5956\u52b1,\u5176\u4f59\u673a\u5236\u548c\u5de5\u4e1a\u9ad8\u7089\u4e00\u81f4."
                },
                {
                    ...
                    "x": 24.0,
                    "y": 48.0,
                    "tooltip": "Time to scale up production! In HV, a handful of n<br/>ew powerful multiblocks are available to you. In p<br/>articular, take a look at the \u00a7lLarge Chemical Rea<br/>ctor\u00a7r, which always perfectly overclocks, as well<br/> as the \u00a7lDistillation Tower\u00a7l\u00a7r, which will allow<br/> you to get all byproducts from distillation inste<br/>ad of targetting just one."
                },
                {
                    "name": "\u7eff\u5de8\u4eba\u91cd\u62f3\u7c89\u788e!",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 60.0,
                    "y": 156.0,
                    "tooltip": "\u5927\u89c4\u6a21\u7834\u574f! \u6216\u8005\u81f3\u5c11,\u53ef\u4ee5\u7c89\u788e\u5f88\u591a\u5f88\u591a\u7684\u77ff\u77f3. \u5efa\u9020\u4e00\u53f0\u5de5\u4e1a\u7c89\u788e\u673a,\u5904\u7406\u4f60\u83b7\u5f97\u7684\u6240\u6709\u77ff\u77f3.\u8fd9\u53f0\u591a\u65b9<br/>\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020,\u4f46\u5b83\u9700\u8981ZPM\u7684\u7535\u8def\u677f. \u526f\u4ea7\u7269\u589e\u4ea7\u7ea6\u4e3a33\uff05."
                },
                {
                    "name": "\u5de5\u4e1a3D\u6253\u5370\u673a",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": -36.0,
                    "y": 180.0,
                    "tooltip": "\u539f\u6728\u5806\u6210\u4e86\u6d77?\u628a\u8fd9\u4e9b\u539f\u6728\u53d8\u6210\u6e05\u6d01\u71c3\u70e7\u7684\u6728\u70ad\u5427!\u5de5\u4e1a\u7126\u7089\u662f3x3x3\u7684\u591a\u65b9\u5757\u673a\u5668,\u8fd0\u884c\u8d77\u6765\u6bd4\u50bb\u5927\u4e2a\u70ed\u89e3<br/>\u7089\u5feb\u591a\u4e86.\u5de5\u4e1a\u7126\u7089\u81f3\u5c11\u670924\u5e76\u884c,\u4e00\u53f0\u9876\u5f97\u4e0a\u5b83\u4eec\u597d\u591a\u53f0.\u4ece\u73b0\u5728\u5f00\u59cb,\u4f60\u53ef\u4ee5\u8ba9\u70ed\u89e3\u7089\u9000\u4f11\u4e86,\u9664\u975e\u6709\u67d0\u4e9b<br/>\u975e\u5e38\u5feb\u7684\u914d\u65b9\u5b83\u4eec\u8fd8\u80fd\u8ddf\u4e0a.\u4e3e\u4e2a\u4f8b\u5b50,\u53ea\u8981\u4f60\u4e3a\u5de5\u4e1a\u7126\u7089\u4f9b\u7ed9\u8db3\u591f\u7684\u6c2e\u6c14,\u5b83\u53ef\u4ee5\u8f7b\u677e\u5403\u4e0b\u4e00\u6574\u4e2a\u6811\u573a\u7684\u539f\u6728\u4ea7<br/>\u51fa,\u5c06\u5176\u8fc5\u901f\u8f6c\u5316\u4e3a\u6728\u70ad!\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728EV\u9636\u6bb5\u5236\u9020,\u4e14\u65e0\u9700\u5408\u91d1\u51b6\u70bc\u7089."
                },
                {
                    "name": "\u5de5\u4e1a\u953b\u9020\u9524",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": 84.0,
                    "y": 252.0,
                    "tooltip": "\u7528\u591a\u65b9\u5757\u91c7\u77ff\u573a\u83b7\u5f97\u7684\u6570\u4ee5\u5343\u8ba1\u7684\u77ff\u77f3\u53ef\u4ee5\u4ea4\u7ed9\u5de5\u4e1a\u79bb\u5fc3\u673a\u5904\u7406.\u8bd1\u8005\u6ce8:\u522b\u542c\u4ed6\u778e\u8bf4,\u6839\u636e\u81ea\u5df1\u7684\u9700\u8981\u9009\u62e9\u6253\u7c89<br/>-\u79bb\u5fc3\u3001\u6d17\u77ff-\u6253\u7c89-\u79bb\u5fc3\u3001\u6d17\u77ff-\u70ed\u79bb-\u6253\u7c89\u8fd9\u4e9b\u5de5\u5e8f.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u6211\u8981\u7684\u662f\u56fa\u4f53\u4e0d\u662f\u6db2\u4f53!",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 228.0,
                    "y": 156.0,
                    "tooltip": "\u6709\u7684\u65f6\u5019\u6211\u4eec\u9700\u8981\u7684\u4e0d\u662f\u5408\u91d1\u51b6\u70bc\u7089. \u8fd9\u53f0\u673a\u5668\u4e5f\u4f7f\u7528\u7ebf\u5708.\u8bf7\u6ce8\u610f,\u8fd9\u662fGT\u5408\u91d1\u7089\u7684\u591a\u65b9\u5757\u7248\u672c,\u800c\u4e0d\u662fG<br/>T++\u5408\u91d1\u51b6\u70bc\u7089\u7684\u56fa\u4f53\u7248\u672c.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u8ba9\u6211\u5236\u9020\u4e00\u4e2a\u65b0\u7684\u5b87\u5b99...",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 240.0,
                    "y": -144.0,
                    "tooltip": "\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u4e13\u7528\u4e8e\u751f\u6210UU-M\u548c\u5e9f\u6599.\u5b83\u4e5f\u662f\u6700\u96be\u5236\u9020\u7684GT++\u591a\u65b9\u5757\u673a\u5668\u4e4b\u4e00,\u4f46\u53ea\u8981\u8ba9\u5b83\u6b63\u5e38\u8fd0\u884c,<br/>\u4f60\u5c31\u53ef\u4ee5\u590d\u5236\u79cd\u7c7b\u7e41\u591a\u7684\u5404\u79cd\u6750\u6599.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728UV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u5de8\u578b\u5408\u91d1\u51b6\u70bc\u7089",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -192.0,
                    "y": 48.0,
                    "tooltip": "\u5de8\u578b\u591a\u65b9\u5757\u673a\u5668\u548cGT++\u7684\u90aa\u6076\u7ed3\u5408\u4e00\u5b9a\u662f\u4e00\u4e9b\u75af\u5b50\u7684\u6770\u4f5c.\u5b83\u662f\u4e00\u53f0\u81f3\u591a256\u5e76\u884c\u7684\u7ec8\u6781\u5408\u91d1\u51b6\u70bc\u7089.\u5982\u679c<br/>\u4f60\u8db3\u591f\u4ed4\u7ec6\u7684\u89c2\u5bdf,\u4f60\u53ef\u4ee5\u53d1\u73b0\u4f7f\u7528\u8db3\u591f\u6602\u8d35\u7684\u7ebf\u5708\u53ef\u4ee5\u5e26\u6765\u51e0\u4e4e\u65e0\u6cd5\u53d1\u73b0\u7684\u901f\u5ea6\u63d0\u5347.\u73bb\u7483\u7684\u7b49\u7ea7\u9650\u5236\u4e86\u80fd\u6e90\u4ed3<br/>\u548c\u914d\u65b9\u7684\u7b49\u7ea7.\u548c\u5176\u4ed6\u591a\u65b9\u5757\u673a\u5668\u4e00\u6837,UEV\u73bb\u7483\u53ef\u4ee5\u89e3\u9501\u6240\u6709\u7b49\u7ea7,\u4f7f\u7528\u6fc0\u5149\u4ed3\u9700\u8981UV\u73bb\u7483."
                },
                {
                ...
                },
                {
                    ...
                    "x": 192.0,
                    "y": -120.0,
                    "tooltip": "As you enter LuV and beyond, fewer mass processing<br/> multiblocks are available as you replace old setu<br/>ps with new systems and scale up the multiblocks y<br/>ou've already built - there are still some importa<br/>nt upgrades in these higher tiers, though. \n\nDefin<br/>itely don't miss out on the Circuit Assembly Line <br/>or you'll be kicking yourself later.\n\nBe a true GT<br/> engineer and finish out your collection!"
                },
                {
                    "name": "\u8d8a\u5927\u8d8a\u597d",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -192.0,
                    "y": 84.0,
                    "tooltip": "\u5bf9\u4e8e\u4e00\u4e2a\u9700\u8981\u70bc\u5236\u8352\u5510\u6570\u91cf\u6750\u6599\u7684\u4eba\u6765\u8bf4,\u8fd9\u53f0\u673a\u5668\u662f\u5b8c\u7f8e\u7684.  \u8fd9\u4e2a\u673a\u5668\u602a\u517d\u53ef\u4ee5\u540c\u65f6\u5904\u7406256\u4e2a\u914d\u65b9.\u73bb<br/>\u7483\u7b49\u7ea7(\u6bd4\u5982\u5728NEI\u641c\u7d22\"\u73bb\u7483\u7b49\u7ea7:HV\")\u9650\u5236\u4e86\u8fd9\u53f0\u673a\u5668\u7684\u6700\u9ad8\u80fd\u6e90\u4ed3\u7b49\u7ea7.\u4f60\u53ef\u4ee5\u901a\u8fc7\u87ba\u4e1d\u5200\u8c03\u6574\u5176\u4e3b<br/>\u65b9\u5757\u6765\u8bbe\u7f6e\u7535\u8def\u677f\u4f18\u5148\u7ea7.\u8bd1\u8005\u6ce8:\u8fd8\u53ef\u4ee5\u7528\u526a\u7ebf\u94b3\u53f3\u952e\u4e3b\u65b9\u5757\u542f\u7528\u72ec\u7acb\u8f93\u5165\u603b\u7ebf\u529f\u80fd."
                },
                {
                    "name": "Megalomania",
                    "symbolSize": 62.400000000000006,
                ...
                },
                {
                    ...
                    "x": 252.0,
                    "y": 180.0,
                    "tooltip": "\u6211\u4e0d\u60f3\u957f\u5927,\u6211\u60f3\u8ddf\u5927\u538b\u6a21\u673a\u73a9.\u4ee5\u9632\u4f60\u6ca1\u5728NEI\u770b\u8fc7\u4e3b\u65b9\u5757\u7684tooltip,\u63d0\u9192\u4e00\u4e0b:\u4f60\u53ef\u4ee5\u5728\u5de5\u4e1a\u538b\u6a21<br/>\u673a\u4e0a\u653e\u7f6e\u591a\u4e2a\u8f93\u5165\u603b\u7ebf,\u6bcf\u4e2a\u603b\u7ebf\u53ef\u653e\u5165\u4e0d\u540c\u7684\u6a21\u5934,\u8fdb\u5165\u76f8\u5e94\u603b\u7ebf\u7684\u6750\u6599\u4f1a\u88ab\u52a0\u5de5\u6210\u6a21\u5934\u5bf9\u5e94\u7684\u6210\u54c1.\u8fd9\u53f0\u591a\u65b9<br/>\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u7cbe\u5bc6\u7ec4\u88c5\u673a",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 192.0,
                    "y": 276.0,
                    "tooltip": "\u7cbe\u5bc6\u7ec4\u88c5\u673a\u6709\u4e24\u79cd\u6a21\u5f0f\uff1a\u7cbe\u5bc6\u6a21\u5f0f\u548c\u5e38\u89c4\u6a21\u5f0f.\u7cbe\u5bc6\u6a21\u5f0f\u662f\u7528\u4e8e\u5236\u9020Good-Generator\u8fd9\u4e2amod\u4e2d<br/>\u7684\u67d0\u4e9b\u5148\u8fdb\u90e8\u4ef6.\u5e38\u89c4\u6a21\u5f0f\u5219\u7c7b\u4f3c\u591a\u65b9\u5757\u7248\u672c\u7684\u7ec4\u88c5\u673a.\u4f60\u4e0d\u80fd\u501f\u52a9\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u8df3\u79d1\u6280.\u9700\u8981\u901a\u8fc7\u5355\u65b9\u5757\u7ec4\u88c5<br/>\u673a\u6216GT++\u591a\u65b9\u5757\u7ec4\u88c5\u673a,\u624d\u80fd\u5236\u9020\u7b2c\u4e00\u4e2a\u9ad8\u9636\u80fd\u6e90\u4ed3,\u7136\u540e\u624d\u80fd\u628a\u5b83\u5b89\u88c5\u5728\u7cbe\u5bc6\u7ec4\u88c5\u673a\u4e0a."
                },
                {
                ...
                },
                {
                    ...
                    "x": 144.0,
                    "y": -96.0,
                    "tooltip": "\u5927\u89c4\u6a21\u81ea\u52a8\u88c5\u914d\u673a\u53ef\u4ee5\u4e3a\u4f60\u7ec4\u88c5\u5927\u91cf\u7684\u7269\u54c1. \u5b83\u7684\u8bbe\u8ba1\u521d\u8877\u662f\u5c06\u7ec4\u88c5\u673a\u3001\u62c6\u89e3\u673a\u548c\u81ea\u52a8\u5408\u6210\u673a\u7684\u529f\u80fd\u96c6\u6210\u5230\u4e00\u8d77<br/>.\u4f46\u662f,\u76ee\u524d\u53ea\u6709\u7ec4\u88c5\u673a\u6a21\u5f0f\u53ef\u7528.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728ZPM\u9636\u6bb5\u5236\u9020.\u867d\u8bf4\u76f8\u6bd4\u7cbe\u5bc6\u7ec4\u88c5\u673a,\u5b83\u6709\u8bb8\u591a\u7f3a\u70b9<br/>,\u6bd4\u65b9\u8bf4\u89e3\u9501\u65f6\u95f4\u665a\u3001\u5e76\u884c\u4e0d\u9ad8\u3001\u4e0d\u652f\u6301TecTech\u80fd\u6e90\u4ed3;\u4e0d\u8fc7\u6709\u4e00\u70b9\u662f\u5b83\u7684\u4f18\u52bf:\u5b83\u652f\u6301\u53cc\u80fd\u6e90\u4ed3\u5347\u538b,<br/>\u5408\u6210\u4e0b\u4e00\u9636\u6bb5\u7684\u7269\u54c1."
                },
                {
                    "name": "See You Lather",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": -24.0,
                    "y": 24.0,
                    "tooltip": "\u4ece\u6d17\u51c0\u7684\u77ff\u77f3\u4e2d\u7b5b\u51fa...\u65e0\u8bba\u5982\u4f55,\u5de5\u4e1a\u7b5b\u9009\u673a\u4f1a\u663e\u8457\u63d0\u9ad8\u7b5b\u9009\u901f\u5ea6.\u4f60\u4f1a\u600e\u4e48\u5904\u7406\u8fd9\u4e9b\u5b9d\u77f3\u5462\uff1f\u5982\u679c\u4f60\u4e0d\u60f3\u7528<br/>\u53cc\u80fd\u6e90\u4ed3\u5347\u538b\u7684\u8bdd,\u5f97\u518d\u505a\u4e00\u4e2a\u673a\u68b0\u65b9\u5757."
                },
                {
                    "name": "\u7194\u5316\u4e07\u7269...",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 72.0,
                    "y": 48.0,
                    "tooltip": "...\u6709\u4e86\u8fd9\u9879\u4f1f\u5927\u7684\u53d1\u660e!\u53ea\u8981\u5347\u7ea7\u4f9b\u7535\u548c\u7ebf\u5708,\u5c31\u53ef\u4ee5\u7194\u70bc\u4e0d\u53ef\u80dc\u6570\u7684\u7269\u54c1."
                },
                {
                    "name": "\u7ed5\u4e86\u4e00\u5708\u53c8\u4e00\u5708",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 252.0,
                    "y": 216.0,
                    "tooltip": "\u60f3\u8981\u7ed5\u5730\u7403\u51e0\u5708\u7684\u5bfc\u7ebf?\u8bd5\u8bd5\u8fd9\u4e2a\u5427.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "Steam Blender?",
                    "symbolSize": 31.200000000000003,
                    "x": 72.0,
                    "y": -120.0,
                    "tooltip": "Why use fancy wiring and circuitry to blend dusts <br/>together when you can do the same thing with steam<br/> and pistons? The Steam Blender is the largest of <br/>these Steam Multiblocks and can handle your mixing<br/> needs for a while, having more parallel than an L<br/>V singleblock Mixer.\n\n[note]This Multiblock can on<br/>ly process recipes up to LV tier and is unable to <br/>process Fluid recipes.[/note]"
                },
                {
                    ...
                    "x": 24.0,
                    "y": -120.0,
                    "tooltip": "You should have quite the collection of single blo<br/>ck Steam machines by now. While these may have got<br/>ten you through processing small amounts of materi<br/>als, there will be a time when you will have to pr<br/>ocess a multitude of items. This is where Multiblo<br/>cks come in.\n\nWhile these Multiblocks have a mater<br/>ial cost that is way higher than their single bloc<br/>k counterparts, they have certain bonuses: they us<br/>e less Steam, and they can process recipes in para<br/>llel, which means that a single recipe cycle can c<br/>raft multiple items at once, if the Steam provided<br/> is enough to sustain it.\n\n\u00a7TThey do however have <br/>some quirks that need to be taken care of:\n\n-These<br/> Multiblocks require \u00a74\u00a7lvery specific\u00a7r I/O block<br/>s, use only those that are part of the quest \n-The<br/>y process up to 8 items, where the Basic Tier is m<br/>ade of Bronze and High Pressure Tier is made of St<br/>eel (checkout the Multiblock Preview in NEI which <br/>will show you different levels of tiers)\n-The Tier<br/> and amount of parallel processing can be seen via<br/> WAILA if you are looking at the Controller Block\n<br/>\n\u00a7W[note]With this quest, you have started your jo<br/>urney with Mass Processing. However, don't get too<br/> excited quite yet. While there are some Multibloc<br/>ks accessible in the Steam Age, most of them only <br/>unlock in EV or later, including better versions o<br/>f these Multiblocks.[/note]"
                },
                {
                    "name": "Steam stomping!",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": 72.0,
                    "y": -84.0,
                    "tooltip": "\u5b83\u662f\u84b8\u6c7d\u7814\u78e8\u673a\u7684\u591a\u65b9\u5757\u7248\u672c.\u4e00\u6b21\u53ea\u80fd\u540c\u65f6\u5904\u74068\u4e2a\u7269\u54c1,\u4e0d\u8fc7\u901f\u5ea6\u66f4\u5feb.\u8bf7\u6ce8\u610f,\u6b64\u591a\u65b9\u5757\u673a\u5668\u8981\u6c42\u975e\u5e38\u7279\u6b8a<br/>\u7684\u8f93\u5165/\u8f93\u51fa\u4ed3\u5ba4,\u522b\u5f04\u9519\u4e86.WIKI \u5927\u578b\u84b8\u6c7d\u7814\u78e8\u673a\uff1agtnh.huijiwiki.com/p/12<br/>8"
                },
                {
                    ...
                    "x": -24.0,
                    "y": 48.0,
                    "tooltip": "You probably haven't thought about the extractor i<br/>n a while. Is your steam extractor still collectin<br/>g dust somewhere? Well, if you do find yourself ne<br/>eding to extract things quick, (processing industr<br/>ial quantities of flowers, maybe?) pick up the Dis<br/>section Apparatus.\n\n[note]This multi gets addition<br/>al parallels based on tier of item pipe casing, so<br/> use the best one you can get![/note]"
                },
                {
                    "name": "\u6d17\u77ff\u5382\u91cc\u7684\u77ff\u77f3...",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 24.0,
                    "y": 276.0,
                    "tooltip": "...\u5468\u800c\u590d\u59cb,24\u5c0f\u65f6\u8fd0\u4f5c. \u4e00\u4e2a\u5927\u578b\u7684\u6d17\u77ff\u5382\u53ef\u4ee5\u5c06\u4f60\u7684\u77ff\u77f3\u53d8\u5f97\u5e72\u51c0\u53c8\u6574\u6d01. \u901a\u8fc7\u87ba\u4e1d\u5200\u53ef\u5207\u6362\u6d17\u77ff<br/>/\u7b80\u6613\u6d17\u77ff\u6a21\u5f0f\u548c\u5316\u5b66\u6d78\u6d17\u6a21\u5f0f.\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                },
                {
                    "name": "\u5df4\u6bd4\u4f26\u5854",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": -96.0,
                    "y": 84.0,
                    "tooltip": "\u55ef...\u5982\u679c\u5c0664\u4e2a\u84b8\u998f\u5854\u5408\u4e3a\u4e00\u5ea7\u4f1a\u53d1\u751f\u4ec0\u4e48...?\u4f60\u61c2\u7684...\u4f60\u4f1a\u5f97\u5230\u4e00\u4e2a61\u5c42\u9ad8\u7684\u591a\u65b9\u5757\u7ed3\u6784.\u6b64<br/>\u591a\u65b9\u5757\u673a\u5668\u4e00\u6b21\u6700\u591a\u53ef\u4ee5\u5904\u7406256\u4e2a\u914d\u65b9."
                },
                {
                    "name": "Under Pressure",
                    "symbolSize": 31.200000000000003,
                    "x": -36.0,
                    "y": 252.0,
                    "tooltip": "Bigger, better, faster. The Large Electric Compres<br/>sor does about what you would expect."
                },
                {
                    ...
                    "x": 240.0,
                    "y": -96.0,
                    "tooltip": "This multiblock will allow you to use all that UU-<br/>Matter that your Matter Fabricator makes, not that<br/> you don't have anything else to do with it...\n\n[n<br/>ote]This multi is UV.[/note]"
                },
                {
                    "name": "\u4f60\u95fb\u8d77\u6765\u50cf\u6389\u5230\u4e86\u9152\u6876\u91cc!",
                    "symbolSize": 31.200000000000003,
                ...
                },
                {
                    ...
                    "x": 228.0,
                    "y": 276.0,
                    "tooltip": "When you need to polarize magnets or separate magn<br/>etic materials, look to the MFE! This multiblock r<br/>equires an electromagnet to be inserted into its h<br/>ousing - better magnets, better bonuses. In IV, yo<br/>u'll be stuck with an Iron Electromagnet, though.\n<br/>\n[note]At the final tier of electromagnet, you can<br/> use TecTech multi-amp hatches. Might be good to r<br/>emember when you're processing a certain magnetic <br/>material...[/note]"
                },
                {
                    "name": "\u55de...\u55de...\u55de...",
                    "symbolSize": 31.200000000000003,
                    ...
                    "x": 132.0,
                    "y": 252.0,
                    "tooltip": "\u9700\u8981\u5927\u91cf\u7684\u6c27\u548c\u6c22,\u6216\u662f\u53ea\u662f\u60f3\u8981\u7535\u89e3\u6750\u6599\u83b7\u5f97\u6210\u5428\u7684\u94dd?\u8fd9\u53f0\u591a\u65b9\u5757\u673a\u5668\u53ef\u4ee5\u5728IV\u9636\u6bb5\u5236\u9020."
                }
            ],
            "edgeLabel": {
                "show": false,
